  ...
  return (
    <>
      <main className="flex flex-col items-center justify-center min-h-screen w-full">
        ...
        {/* Why choose ShopNet */}
        <section className="flex flex-col items-center justify-center gap-4 w-full min-h-screen flex-shrink-0 bg-slate-200 relative pt-16 mt-4 dark:bg-slate-800 0">
          <img
            src={`/waves/${
